...
class Version implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['rosetta_version'] = isset($data['rosetta_version']) ? $data['rosetta_version'] : null;
        $this->container['node_version'] = isset($data['node_version']) ? $data['node_version'] : null;
        $this->container['middleware_version'] = isset($data['middleware_version']) ? $data['middleware_version'] : null;
