...
interface MempoolApiInterface
{
     ...
     *
     * @param  melmccann\rosettaserverstubs\Model\MempoolRequest $mempoolRequest   (required)
     * @param  integer $responseCode     The HTTP response code to return
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     * @return melmccann\rosettaserverstubs\Model\MempoolResponse
     *
     */
     ...
     *
     * @param  melmccann\rosettaserverstubs\Model\MempoolTransactionRequest $mempoolTransactionRequest   (required)
     * @param  integer $responseCode     The HTTP response code to return
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     * @return melmccann\rosettaserverstubs\Model\MempoolTransactionResponse
     *
     */
