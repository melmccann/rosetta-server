...
{
        /**
     * @var melmccann\rosettaserverstubs\RosettaServerStubsModel\OperationIdentifier
     * @SerializedName("operation_identifier")
     * @Assert\NotNull()
     * @Assert\Type("melmccann\rosettaserverstubs\RosettaServerStubsModel\OperationIdentifier")
     * @Type("melmccann\rosettaserverstubs\RosettaServerStubsModel\OperationIdentifier")
     */
     ...
     *
     * @var melmccann\rosettaserverstubs\RosettaServerStubsModel\OperationIdentifier[]|null
     * @SerializedName("related_operations")
     * @Assert\All({
     *   @Assert\Type("melmccann\rosettaserverstubs\RosettaServerStubsModel\OperationIdentifier")
     * })
     * @Type("array<melmccann\rosettaserverstubs\RosettaServerStubsModel\OperationIdentifier>")
     */
    ...
    /**
     * @var melmccann\rosettaserverstubs\RosettaServerStubsModel\AccountIdentifier|null
    ...
    /**
     * @var melmccann\rosettaserverstubs\RosettaServerStubsModel\Amount|null
     * @SerializedName("amount")
     * @Assert\Type("melmccann\rosettaserverstubs\RosettaServerStubsModel\Amount")
     * @Type("melmccann\rosettaserverstubs\RosettaServerStubsModel\Amount")
     */
    protected $amount;
     ...
     *
     * @return melmccann\rosettaserverstubs\RosettaServerStubsModel\OperationIdentifier
     */
     ...
     *
     * @param melmccann\rosettaserverstubs\RosettaServerStubsModel\OperationIdentifier $operationIdentifier
     *
     * @return $this
     */
     ...
     *
     * @return melmccann\rosettaserverstubs\RosettaServerStubsModel\OperationIdentifier[]|null
     */
     ...
     *
     * @param melmccann\rosettaserverstubs\RosettaServerStubsModel\OperationIdentifier[]|null $relatedOperations  Restrict referenced related_operations to identifier indexes < the current operation_identifier.index. This ensures there exists a clear DAG-structure of relations.  Since operations are one-sided, one could imagine relating operations in a single transfer or linking operations in a call tree.
     *
     * @return $this
     */
     ...
     * Gets account.
     *
     * @return melmccann\rosettaserverstubs\RosettaServerStubsModel\AccountIdentifier|null
     */
     ...
     * Sets account.
     *
     * @param melmccann\rosettaserverstubs\RosettaServerStubsModel\AccountIdentifier|null $account
     *
     * @return $this
     */
     ...
     * Gets amount.
     *
     * @return melmccann\rosettaserverstubs\RosettaServerStubsModel\Amount|null
     */
     ...
     * Sets amount.
     *
     * @param melmccann\rosettaserverstubs\RosettaServerStubsModel\Amount|null $amount
     *
     * @return $this
     */
