...
class Allow 
{
     ...
     *
     * @var melmccann\rosettaserverstubs\Model\OperationStatus[]
     * @SerializedName("operation_statuses")
     * @Assert\NotNull()
     * @Assert\All({
     *   @Assert\Type("melmccann\rosettaserverstubs\Model\OperationStatus")
     * })
     * @Type("array<melmccann\rosettaserverstubs\Model\OperationStatus>")
     */
     ...
     *
     * @var melmccann\rosettaserverstubs\Model\Error[]
     * @SerializedName("errors")
     * @Assert\NotNull()
     * @Assert\All({
     *   @Assert\Type("melmccann\rosettaserverstubs\Model\Error")
     * })
     * @Type("array<melmccann\rosettaserverstubs\Model\Error>")
     */
    protected $errors;
     ...
     *
     * @return melmccann\rosettaserverstubs\Model\OperationStatus[]
     */
     ...
     *
     * @param melmccann\rosettaserverstubs\Model\OperationStatus[] $operationStatuses  All Operation.Status this implementation supports. Any status that is returned during parsing that is not listed here will cause client validation to error.
     *
     * @return $this
     */
     ...
     * Gets errors.
     *
     * @return melmccann\rosettaserverstubs\Model\Error[]
     */
     ...
     * Sets errors.
     *
     * @param melmccann\rosettaserverstubs\Model\Error[] $errors  All Errors that this implementation could return. Any error that is returned during parsing that is not listed here will cause client validation to error.
     *
     * @return $this
     */
