...
{
        /**
     * @var OpenAPI\Server\Model\OperationIdentifier
     * @SerializedName("operation_identifier")
     * @Assert\NotNull()
     * @Assert\Type("OpenAPI\Server\Model\OperationIdentifier")
     * @Type("OpenAPI\Server\Model\OperationIdentifier")
     */
     ...
     *
     * @var OpenAPI\Server\Model\OperationIdentifier[]|null
     * @SerializedName("related_operations")
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\OperationIdentifier")
     * })
     * @Type("array<OpenAPI\Server\Model\OperationIdentifier>")
     */
    ...
    /**
     * @var OpenAPI\Server\Model\AccountIdentifier|null
    ...
    /**
     * @var OpenAPI\Server\Model\Amount|null
     * @SerializedName("amount")
     * @Assert\Type("OpenAPI\Server\Model\Amount")
     * @Type("OpenAPI\Server\Model\Amount")
     */
    protected $amount;
     ...
     *
     * @return OpenAPI\Server\Model\OperationIdentifier
     */
     ...
     *
     * @param OpenAPI\Server\Model\OperationIdentifier $operationIdentifier
     *
     * @return $this
     */
     ...
     *
     * @return OpenAPI\Server\Model\OperationIdentifier[]|null
     */
     ...
     *
     * @param OpenAPI\Server\Model\OperationIdentifier[]|null $relatedOperations  Restrict referenced related_operations to identifier indexes < the current operation_identifier.index. This ensures there exists a clear DAG-structure of relations.  Since operations are one-sided, one could imagine relating operations in a single transfer or linking operations in a call tree.
     *
     * @return $this
     */
     ...
     * Gets account.
     *
     * @return OpenAPI\Server\Model\AccountIdentifier|null
     */
     ...
     * Sets account.
     *
     * @param OpenAPI\Server\Model\AccountIdentifier|null $account
     *
     * @return $this
     */
     ...
     * Gets amount.
     *
     * @return OpenAPI\Server\Model\Amount|null
     */
     ...
     * Sets amount.
     *
     * @param OpenAPI\Server\Model\Amount|null $amount
     *
     * @return $this
     */
