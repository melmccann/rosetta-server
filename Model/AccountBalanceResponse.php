...
class AccountBalanceResponse 
{
     ...
     *
     * @var melmccann\rosettaserverstubs\Model\Amount[]
     * @SerializedName("balances")
     * @Assert\NotNull()
     * @Assert\All({
     *   @Assert\Type("melmccann\rosettaserverstubs\Model\Amount")
     * })
     * @Type("array<melmccann\rosettaserverstubs\Model\Amount>")
     */
    protected $balances;
     ...
     * Gets balances.
     *
     * @return melmccann\rosettaserverstubs\Model\Amount[]
     */
     ...
     * Sets balances.
     *
     * @param melmccann\rosettaserverstubs\Model\Amount[] $balances  A single account may have a balance in multiple currencies.
     *
     * @return $this
     */
