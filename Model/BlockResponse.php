...
{
        /**
     * @var melmccann\rosettaserverstubs\Model\Block
     * @SerializedName("block")
     * @Assert\NotNull()
     * @Assert\Type("melmccann\rosettaserverstubs\Model\Block")
     * @Type("melmccann\rosettaserverstubs\Model\Block")
     */
    protected $block;
     ...
     *
     * @var melmccann\rosettaserverstubs\Model\TransactionIdentifier[]|null
     ...
     * Gets block.
     *
     * @return melmccann\rosettaserverstubs\Model\Block
     */
     ...
     * Sets block.
     *
     * @param melmccann\rosettaserverstubs\Model\Block $block
     *
     * @return $this
     */
     ...
     *
     * @return melmccann\rosettaserverstubs\Model\TransactionIdentifier[]|null
     */
     ...
     *
     * @param melmccann\rosettaserverstubs\Model\TransactionIdentifier[]|null $otherTransactions  Some blockchains may require additional transactions to be fetched that weren't returned in the block response (ex: block only returns transaction hashes). For blockchains with a lot of transactions in each block, this can be very useful as consumers can concurrently fetch all transactions returned.
     *
     * @return $this
     */
